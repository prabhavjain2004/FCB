...
# Confirm deletion
print("\n" + "!" * 60)
print("WARNING: This will DELETE ALL bookings permanently!")
print("!" * 60)
...
print("2. Make new test bookings")
print("3. Check the revenue page to see fresh data")
